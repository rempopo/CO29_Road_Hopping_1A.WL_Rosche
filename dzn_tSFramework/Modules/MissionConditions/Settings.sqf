...
MissionCondition1 = [ "WIN", {[ [TRG_1, TRG_2], "east", "", "< 3"] call dzn_fnc_ccUnits && !alive TGT1 && !alive TGT2 && !alive TGT3}   , "All primary and optional objectives done" ];
MissionCondition2 = [ "WIN2", {[ [TRG_1, TRG_2], "east", "", "< 3"] call dzn_fnc_ccUnits && alive TGT1 && alive TGT2 && alive TGT3}, "All primary objectives done" ];
